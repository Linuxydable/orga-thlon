...
public class Course3 {
	...
	public Course3 (String nom1, boolean predefini) throws Exception {
		
		
		 try {
	      Class.forName("com.mysql.jdbc.Driver");
		  connect = DriverManager.getConnection("jdbc:mysql://...:3306/Orgathlon" + "?user=...&password=...");
	...
	public String getNom(int id) throws Exception {
		//Au lieu de retourner le nom, retourne un select du nom pour une course donn�e 
	...
	public int getDuree() {
		//calcul�e, il faut 2 dates : d�but et fin de la course
		return duree;
	}
