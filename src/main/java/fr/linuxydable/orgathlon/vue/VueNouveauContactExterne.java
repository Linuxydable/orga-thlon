...
public class VueNouveauContactExterne extends JPanel {
	...
	public VueNouveauContactExterne() {
		...
		//ligne 0 : Soci�t�  (Jlabel + JTextField) + Titre (JLabel + JComBox)
		lb = new JLabel("Soci�t�");
		c.gridx = 0;
		c.gridy = 0;
		...
		//ligne 1 : T�l�phone  (Jlabel + JTextField) + Nom (JLabel + JTextField)
		lb = new JLabel("T�l�phone   ");
		c.gridx = 0;
		c.gridy = 1;
		c.anchor = GridBagConstraints.LINE_START;
		northPanel.add(lb,c); 
		...
		//ligne 2 : Email  (Jlabel + JTextField) + Pr�nom (JLabel + JTextField)
