...
import fr.linuxydable.orgathlon.controleur.ControleurNouvelleCourse;
import fr.linuxydable.orgathlon.modele.Etat.Etat;
...
public class FenetreNouvelleCourse extends JFrame {
	...
	public FenetreNouvelleCourse() throws Exception {
		...
		this.btDateDebutCourse.setIcon(new ImageIcon("./src/fr.linuxydable.orgathlon.vue/calendar.png"));
		...
		//this.btDateDebutCourse.addActionListener(fr.linuxydable.orgathlon.controleur);
